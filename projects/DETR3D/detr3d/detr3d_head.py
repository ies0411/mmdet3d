...
class DETR3DHead(DETRHead):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(DETR3DHead, self).__init__(transformer=transformer, *args, **kwargs)
    ...
    def forward(
        self, mlvl_feats: List[Tensor], img_metas: List[Dict], **kwargs
    ) -> Dict[str, Tensor]:
        """Forward function.
    ...
    def loss_by_feat_single(
        ...
        cls_reg_targets = self.get_targets(
            cls_scores_list, bbox_preds_list, batch_gt_instances_3d
        )
        ...
        if self.sync_cls_avg_factor:
            cls_avg_factor = reduce_mean(batch_cls_scores.new_tensor([cls_avg_factor]))
